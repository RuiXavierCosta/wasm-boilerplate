    ...
    <footer ref={ref} className="container d-flex flex-column justify-content-between align-items-start py-5">
      ...
      <div className="footer-content justify-self-end mt-5 ms-5">
        <p className="say-hi fs-6">
          ...
          Don&apos;t forget to <a href={parsedMailTo} className="text-light" target="_blank" rel="noreferrer">
            say hi!
          </a>
        </p>
        <div className="link-container mt-5 d-flex">
          <a href="https://www.linkedin.com/in/ruixaviercosta" target="_blank" rel="noreferrer">
            <Image height={32} width={32} className="external-logo" src={linkedinLogo} alt="Linkedin Profile"/>
          </a>
          <a href="https://github.com/RuiXavierCosta" className="ms-3" target="_blank" rel="noreferrer">
            <Image height={32} width={32} className="external-logo" src={githubLogo} alt="Github Profile"/>
          </a>
          <a href="https://codepen.io/XavierCosta" className="ms-3" target="_blank" rel="noreferrer">
            <Image height={32} width={32} className="external-logo" src={codepenLogo} alt="Codepen Profile"/>
          </a>
        </div>
